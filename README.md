...
## Usage
Import both Bootstrap and the library in your JavaScript file:
```javascript
import * as bootstrap from 'bootstrap';
import BCLightboxModal from 'bc-lightbox-modal';
```
Then, initialize it, making sure to pass in your bootstrap instance:
```javascript
const lightbox = new BCLightboxModal(bootstrap);
```
...
```javascript
const lightbox = new BCLightboxModal(boostrap, 'my-modal-id', '[data-my-lightbox]');
```
